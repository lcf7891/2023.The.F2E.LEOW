<template>
  <article class="bg-info p-16">
    <div class="container">
      <div class="row row-cols-lg-2 row-cols-1 g-0">
        <div class="col bg-white rounded-left24 py-lg-16 py-10 px-lg-10 px-6">
          <div class="text-center mb-8">
            <span class="bg-secondary rounded-3
                  h6 text-white fw-bold py-2 px-3 mb-0">
              ADVOCATE
            </span>
          </div>
          <h2 class="display-2 font-mantou text-primary-gradient text-center mb-8">
            候選人主張
          </h2>
          <p class="h3 fw-bold mb-8">
            我堅信 ! 藉由推動更完善的
            <span class="text-primary mb-0">貓咪福利</span>
            和相關政策，更是間接地投資於
            <span class="text-primary mb-0">台灣的未來</span>。
          </p>
